/* This file is downloaded from an online source to only test the ESP8266 wifi module.
   The main function is to test the wifi is working and print out the IP address of the wifi module.
 */
...
const char* host = "server_host";  // IP serveur - Server IP
...
void loop() {
  ...
  if ( currentMillis - previousMillis > watchdog ) {
    ...
    // The things that will be sent to the server
    ...
    // Data sent by the server to control the water pump
